...
public class InsertData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			conn = DriverManager.getConnection("jdbc:mysql://localhost/MSOffice1","root" ,"" );
			...
			String sql = "INSERT INTO products (id, producttype, productname, price, qty, img) VALUES" +
		    		...
		    		"(102,'Licence Key', '3 Month Subcription', 28, 1000, '/img/3month.png'),"+
		    		"(103,'Licence Key', '6 Month Subcription', 55, 1000, '/img/6month.png'),"+
		    		"(104,'Licence Key', '12 Month Subcription', 100, 1000, '/img/12month.png');";
