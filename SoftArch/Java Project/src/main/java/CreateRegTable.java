...
public class CreateRegTable extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			connect = DriverManager.getConnection("jdbc:mysql://localhost/MSOffice1","root" ,"" ); 
			// STEP 3: Statements allow us to issue SQL queries to the database
			statement = connect.createStatement();
			// STEP 4: declare a query
			String sql = "CREATE TABLE userTable (username VARCHAR(50), pass VARCHAR(50), email VARCHAR(50), userPostalRegion VARCHAR(50));";
